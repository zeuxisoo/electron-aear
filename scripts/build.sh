...
# Package mac app
./node_modules/.bin/electron-packager ./dist Aear --platform=darwin --arch=x64 --version=1.3.5 --icon=./dist/icon.icns --asar --overwrite

rm -rf ./Aear-darwin-x64/LICENSES.chromium.html
rm -rf ./Aear-darwin-x64/LICENSE
rm -rf ./Aear-darwin-x64/version

# Package win app
./node_modules/.bin/electron-packager ./dist Aear --platform=win32 --arch=x64 --version=1.3.5 --icon=./dist/icon.ico --asar --overwrite

rm -rf ./Aear-win32-x64/LICENSES.chromium.html
rm -rf ./Aear-win32-x64/LICENSE
rm -rf ./Aear-win32-x64/version
rm -rf ./Aear-win32-x64/resources/default_app
